// assets/js/views/scenarioView.js - Ekran misji z obsługą GIF/Wideo i fallbackiem
...
export function renderMission(container, navigate, appState, scenarioId) {
  ...
  function renderStep() {
    ...
    // Generowanie odpowiedniego tagu HTML w zależności od formatu (GIF vs Wideo)
    let mediaHtml = '';
    if (mediaSrc) {
      if (isGif) {
        mediaHtml = `
      ...
      <div class="fade-in" style="padding: 1.2rem; max-width: 600px; margin: 0 auto; width: 100%; min-height: 100vh; display: flex; flex-direction: column; justify-content: space-between; background: #fdfbf7; font-family: sans-serif;">
        <div>
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
            <h3 style="color: #1e293b; margin: 0; font-size: 1.1rem;">${scenario.title}</h3>
